...
exports.EMAIL_VERIFICATION_SUBJECT = "Your OTP for Email Verification - Shopio"

exports.PASSWORD_RESET_SUBJECT = "Password reset verification - Shopio"

exports.OTP_EMAIL_TEMPLATE = (data) =>
  `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
exports.PASSWORD_RESET_EMAIL_TEMPLATE = (data) =>
  `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
exports.resetPasswordToken = async () => crypto.randomBytes(16).toString("hex")

exports.generateHash = async (data) =>
  crypto.createHash("sha256").update(data).digest("hex")

exports.checkValidKey = (keyData, bodyData) => {
