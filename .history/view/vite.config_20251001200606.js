...
export default defineConfig(({ command, mode }) => {
  ...
  build: {
    // Output directory
    outDir: '../server/view',
    // Allow cleaning when output is outside project root
    emptyOutDir: true,
    ...
    rollupOptions: {
      output: {
        ...
        manualChunks: {
          ...
          // Removed invalid directory paths in manual chunks to avoid resolution errors
        },
        // Asset naming
  ...
  css: {
    ...
    postcss: {
      plugins: [
        ...
        // Note: Install autoprefixer as dev dependency
