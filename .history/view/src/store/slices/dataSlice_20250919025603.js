...
export const fetchProducts = createAsyncThunk(
  ...
  async (params = {}, { rejectWithValue }) => {
    try {
      const response = await apiService.product.getAllProducts(params);
...
export const fetchProductDetails = createAsyncThunk(
  ...
  async (productId, { rejectWithValue }) => {
    try {
      const response = await apiService.product.getProductDetails(productId);
...
export const fetchOrders = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await apiService.order.getMyOrders();
...
export const fetchOrderDetails = createAsyncThunk(
  ...
  async (orderId, { rejectWithValue }) => {
    try {
      const response = await apiService.order.getOrderDetails(orderId);
      return response.data.order;
    } catch (error) {
      return rejectWithValue(
