...
import { userApi, productApi, orderApi, cartApi, paymentApi } from './apiService';
...
export const useEnhancedUserApi = () => {
  ...
  return {
    ...
    register: (userData) => enhancedUserApi.register(userData, {
      successMessage: 'Registration successful! Welcome to our platform.',
      errorMessage: 'Registration failed. Please try again.',
    }),
    
    login: (credentials) => enhancedUserApi.login(credentials, {
      successMessage: 'Login successful! Welcome back.',
      errorMessage: 'Login failed. Please check your credentials.',
    }),
    
    logout: () => enhancedUserApi.logout({
      successMessage: 'Logged out successfully.',
      showError: false, // Don't show error for logout
    }),
    
    updateProfile: (profileData) => enhancedUserApi.updateProfile(profileData, {
      successMessage: 'Profile updated successfully!',
      errorMessage: 'Failed to update profile. Please try again.',
    }),
    
    updatePassword: (passwordData) => enhancedUserApi.updatePassword(passwordData, {
      successMessage: 'Password updated successfully!',
      errorMessage: 'Failed to update password. Please try again.',
    }),
    
    forgotPassword: (email) => enhancedUserApi.forgotPassword(email, {
      successMessage: 'Password reset email sent! Check your inbox.',
      errorMessage: 'Failed to send reset email. Please try again.',
    }),
    
    resetPassword: (token, passwordData) => enhancedUserApi.resetPassword(token, passwordData, {
      successMessage: 'Password reset successfully! You can now login.',
      errorMessage: 'Failed to reset password. Please try again.',
    }),
    
    uploadImage: (formData) => enhancedUserApi.uploadImage(formData, {
...
export const useEnhancedProductApi = () => {
  ...
  return {
    ...
    // Override specific methods with custom messages
    createProduct: (productData) => enhancedProductApi.createProduct(productData, {
      successMessage: 'Product created successfully!',
      errorMessage: 'Failed to create product. Please try again.',
    }),
    
    updateProduct: (productId, productData) => enhancedProductApi.updateProduct(productId, productData, {
      successMessage: 'Product updated successfully!',
      errorMessage: 'Failed to update product. Please try again.',
    }),
    
    deleteProduct: (productId) => enhancedProductApi.deleteProduct(productId, {
...
export const useEnhancedOrderApi = () => {
  ...
  return {
    ...
    // Override specific methods with custom messages
    createOrder: (orderData) => enhancedOrderApi.createOrder(orderData, {
      successMessage: 'Order placed successfully!',
      errorMessage: 'Failed to place order. Please try again.',
    }),
    
    updateOrderStatus: (orderId, status) => enhancedOrderApi.updateOrderStatus(orderId, status, {
...
export const useEnhancedCartApi = () => {
  ...
  return {
    ...
    // Override specific methods with custom messages
    addToCart: (productId, quantity) => enhancedCartApi.addToCart(productId, quantity, {
      successMessage: 'Item added to cart!',
      errorMessage: 'Failed to add item to cart. Please try again.',
    }),
    
    updateCartItem: (itemId, quantity) => enhancedCartApi.updateCartItem(itemId, quantity, {
      successMessage: 'Cart updated successfully!',
      errorMessage: 'Failed to update cart. Please try again.',
    }),
    
    removeFromCart: (itemId) => enhancedCartApi.removeFromCart(itemId, {
      successMessage: 'Item removed from cart!',
      errorMessage: 'Failed to remove item from cart. Please try again.',
    }),
    
    clearCart: () => enhancedCartApi.clearCart({
...
export const useEnhancedPaymentApi = () => {
  ...
  return {
    ...
    // Override specific methods with custom messages
    processPayment: (paymentData) => enhancedPaymentApi.processPayment(paymentData, {
      successMessage: 'Payment processed successfully!',
      errorMessage: 'Payment failed. Please try again.',
    }),
    
    createPaymentIntent: (amount) => enhancedPaymentApi.createPaymentIntent(amount, {
