...
export const userApi = {
  // Authentication
  register: (userData) => apiCall('USER', 'REGISTER', { data: userData }),

  login: (credentials) => apiCall('USER', 'LOGIN', { data: credentials }),

  logout: () => apiCall('USER', 'LOGOUT'),
  ...
  // Profile Management
  getMyDetails: () => apiCall('USER', 'GET_MY_DETAILS'),
  ...
  getAllUsers: () => apiCall('USER', 'GET_ALL_USERS'),
...
export const cartApi = {
  addToCart: (cartData) => apiCall('CART', 'ADD_TO_CART', { data: cartData }),

  getMyCart: () => apiCall('CART', 'GET_MY_CART'),
...
export const orderApi = {
  ...
  getMyOrders: () => apiCall('ORDER', 'GET_MY_ORDERS'),

  // Admin Order Management
  getAllOrders: () => apiCall('ORDER', 'GET_ALL_ORDERS'),
...
export const uploadApi = {
  ...
  getUploadStats: () => apiCall('UPLOAD', 'GET_UPLOAD_STATS'),
};
