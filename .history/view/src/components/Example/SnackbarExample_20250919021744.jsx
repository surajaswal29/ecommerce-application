...
const SnackbarExample = () => {
  ...
  const testApiSuccess = async () => {
    try {
      ...
      await handleAsync(
        () => new Promise(resolve => setTimeout(() => resolve({ data: { message: 'API call successful!' } }), 1000)),
        {
  ...
  const testApiError = async () => {
    try {
      ...
      await handleAsync(
        () => new Promise((_, reject) => setTimeout(() => reject(new Error('API call failed!')), 1000)),
        {
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
        This component demonstrates all the Snackbar features and usage patterns.
      </Typography>
