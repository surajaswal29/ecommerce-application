...
const ProductDetails = () => {
  const { id } = useParams();
  const { productDetailsDetails, productDetailsDetailsLoading, getProductDetails, addItemToCart } = useData();
  ...
  return (
    <>
      {productDetailsDetailsLoading ? (
        <Loader />
      ) : (
        <>
          <MetaData title={productDetailsDetails?.name} />
          <div className="container single-productDetails">
            ...
            <div className="row mt-5">
              ...
              <div className="col-md-7 productDetails-desc-details">
                ...
                <div className={`my-2 ${productDetails.stock > 0 ? "green" : "red"}`}>
                  Status: {productDetails.stock > 0 ? "In Stock" : "Out of Stock"}
                </div>
