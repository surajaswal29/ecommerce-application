...
const AllProduct = () => {
  ...
  const { productsLoading, products, productsCount, getProducts } = useData();
  ...
  }, [getProducts, keyword, currentPage, category, price]);
          ...
          <div className='container-fluid' id='products'>
            <div className='row mt-3 px-2 bd-bottom'>
              ...
              <div className='col-md-12 mt-2 all-product-heading pr-center-even'>
                ...
                <span
                  ...
                  onClick={(e) => showFiltersOnMobile(e)}
                  ref={filterBtn}
                >
                  Filter <BiFilterAlt />
                </span>
            ...
            <div className='row'>
              ...
              <div className='col-md-12 mt-5 pr-center'>
                ...
                products.length > 0 &&
                productsCount > 8 &&
                (keyword || category ? products.length >= 8 : 8) ? (
                  <Pagination
