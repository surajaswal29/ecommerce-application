    ...
    <div className="container-fluid ecom-header">
      <div className="row">
        ...
        <div className="col-md-4 main-logo align-items-center py-0">
          <div className="logo">
            <Link to="/" className="logo-link">
              <img src={BBlogo} className="img-fluid" alt="Eccom-App Logo" />
              <span className="logo-text">Eccom-App</span>
            </Link>
          </div>
          ...
          <div className="ham-menu" onClick={() => setMobileMenuOpen(!mobileMenuOpen)}>
            <MdMenu />
          </div>
        </div>
        ...
        <div className="col-md-3 info-bar pr-center">
          ...
          <Link to={"/mycart"} className="pr-center cart-link">
            <MdShoppingCart />
