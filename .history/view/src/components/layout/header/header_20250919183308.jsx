...
const Header = () => {
  ...
  return (
    <div className="container-fluid ecom-header">
      <div className="row">
        {/* logo, category */}
        <div className="col-md-4 main-logo align-items-center">
          <div className="logo">
          ...
          <div className="address-box d-flex align-items-center">
            ...
            >
              ...
              <div className={clickStatus === 1 ? "cat-dropdown show" : "cat-dropdown"}>
                <Category />
              </div>
            </div>
          </div>
        ...
        <div className="col-md-3 info-bar d-flex align-items-center justify-content-end">
          {isAuthenticated ? (
            ...
            >
              ...
              <MdKeyboardArrowDown />
              <div className={userProfile === 1 ? "cat-dropdown user-dropdown show" : "cat-dropdown user-dropdown"}>
          ...
          <Link to={"/mycart"} className="cart-link d-flex align-items-center">
            <MdShoppingCart />
            <sup className="cart-count" key={cartItems.length}>
              {cartItems.length}
            </sup>
