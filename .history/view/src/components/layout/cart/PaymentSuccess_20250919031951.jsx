                            ...
                            <div className="order-msg">
                                ...
                                <div className="payment-details bg-light p-3 rounded mb-3">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-6">
                                            <p><strong>Status:</strong> <span className="text-success">{paymentData.status || 'Completed'}</span></p>
                                            <p><strong>Date:</strong> {paymentData.created_at ? new Date(paymentData.created_at).toLocaleDateString() : new Date().toLocaleDateString()}</p>
                                        </div>
                                    </div>
                                </div>
