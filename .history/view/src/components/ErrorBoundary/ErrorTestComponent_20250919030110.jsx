  ...
  return (
    <div className="error-test-component p-4">
      <Alert variant="warning">
        ...
        <p>This component is for testing the Error Boundary functionality. Click the buttons below to trigger different types of errors.</p>
      </Alert>
      ...
      <Alert variant="info" className="mt-3">
        <small>
          <strong>Note:</strong> Error Boundary only catches errors in React components during rendering, 
          lifecycle methods, and constructors. It does not catch errors in event handlers, async code, 
