...
This document outlines the changes made to refactor the authentication system
from cookie-based to localStorage-based JWT authentication.

## Overview

The authentication system has been updated to use localStorage for storing JWT
tokens instead of HTTP-only cookies. This provides better control over token
management and is suitable for single-page applications.
