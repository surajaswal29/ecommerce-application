...
if (
  ...
  console.warn(
    "⚠️  Cloudinary configuration incomplete. Image uploads may not work properly."
  )
}
...
const server = app.listen(config.port, () => {
  ...
  console.log(
    `   🗄️  Database: ${config.database.uri ? "Configured" : "Not configured"}`
  )
  console.log(
    `   ☁️  Cloudinary: ${
  ...
  console.log(
    `   ⚙️  Config Status: ${isConfigValid ? "✅ Valid" : "⚠️  Incomplete"}`
  )
  console.log("=" * 50)
})
